...
Version  : 1.1.0
Release  : 24
URL      : https://cran.r-project.org/src/contrib/lhs_1.1.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/lhs_1.1.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601404472
