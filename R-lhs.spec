...
Version  : 1.1.1
Release  : 26
URL      : https://cran.r-project.org/src/contrib/lhs_1.1.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/lhs_1.1.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602176060
